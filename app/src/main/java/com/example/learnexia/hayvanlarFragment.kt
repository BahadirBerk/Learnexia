 ...
 * Use the [hayvanlarFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class hayvanlarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v = inflater.inflate(R.layout.fragment_hayvanlar, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment hayvanlarFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            hayvanlarFragment().apply {
